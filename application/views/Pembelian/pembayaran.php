...
<?php
if( ! empty($pembayaran_tb)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
	foreach($pembayaran_tb as $data){ // Lakukan looping pada variabel gambar dari controller
		echo "<tr>";
		?>
	<?php if ($this->session->userdata('email') != "admin@gmail.com") { ?>
<?php }?>
